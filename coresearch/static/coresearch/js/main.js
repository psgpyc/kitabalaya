  ...
  inp.addEventListener("input", function(e) {
      ...
      for (i = 0; i < arr.length; i++) {
        ...
        if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
          ...
          b.innerHTML += "  <i class=\"fas fa-search\" aria-hidden=\"true\" style='float: right; color: #427885; margin-right: 10px;' '></i>\n";
...
autocomplete(document.getElementById("search-parameter"), countries);
// $('#search-parameter').submit();
